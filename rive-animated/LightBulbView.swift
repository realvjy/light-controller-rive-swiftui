...
struct OpacitySlider: View {
    ...
    init(opacity: Binding<Double>, isLightOn: Bool) {
    ...
    var body: some View {
        ...
        .onChange(of: opacity) { newValue in
            // Always update the thumb color based on slider position
...
//                                                    ) // Inner shadow
                                                ...
                                                ZStack {
                                                    ...
                                                    Circle()
                                                        ...
                                                        .offset(y: isLightOn ? 1 : 8)
                                                        .blur(radius: isLightOn ? 1 : 6)
                                                    Circle()
                                                        .fill(
                                                            LinearGradient(
                                                                colors: [
                                                                    Color(hex: isLightOn ? "#222838" : "#191D21"),
                                                                    Color(hex: "#111415")
                                                                ],
                                                                startPoint: .top,
                                                                endPoint: .bottom
                                                        ...
                                                        .stroke(Color.black.opacity(1), lineWidth: 0.5)
                                                        .overlay(
                                                            Circle()
                                                                .stroke(Color.white.opacity(isLightOn ? 0.2 : 0.1), lineWidth: 1)
                                                                .offset(x: 0, y: 0.5)
                                                                .mask(
                                                                    Circle()
                                                                        .fill(
                                            ...
                                            .overlay(
                                                ZStack {
                                                    ...
                                                    Image(systemName: "power")
                                                        .foregroundColor(isLightOn ? .white : .white.opacity(0.5))
                                                        .font(.system(size: 18, weight: .bold))
                                                }
                                        ...
                                        .opacity(1.0)
                                        .animation(nil, value: isLightOn) // Disable animation effect
                                    }
                                    .padding(.top, 16)
                                    .modifier(
                                        DebugLayoutModifier(
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                VStack {
                    Text("I was just playing around with SwiftUI and Rive and made this little app as a test.")
                        .font(.body)
                        .padding()
                    Text("The source code is available on GitHub, and the Rive file can be found in the community.")
                        .font(.body)
                        .padding()
                    Text("I'd love to hear your feedback! Feel free to use it in any of your projects.")
                        .font(.body)
                        .padding()
                }
                .frame(width: 250)
                ...
                HStack{
                    ZStack{
                        VStack{
                            Text("Designed and Developed by").font(.system(size: 14)).opacity(0.7)
                            Image("realvjy")
                                .opacity(1)
                                .scaledToFit()
                                .aspectRatio(contentMode: .fit)
                            HStack{
                                Link("Twitter", destination: URL(string: "https://www.x.com/realvjy")!)
                                    ...
                                    .padding(6)
                                Link("Github", destination: URL(string: "https://github.com/realvjy/light-controller-rive-swiftui")!)
                                    .foregroundStyle(Color(Color(hex: "1B90FF")))
                                    .font(.system(size: 15)).opacity(0.9)
                            }
                        }
